...
- Theme: Light, minimal, warm neutral
- Background: Warm Cream (#FCFBF9)
- Surface: Cream Surface (#FAF8EF) for form card
- Primary Accent: Sage (#A4B0A3) for submit button and links
- Text Primary: Warm Charcoal (#332E2D) for headings
- Text Secondary: Soft Gray (#7E8187) for labels
- Buttons: Subtly rounded (10px), full-width on form
- Cards: Gently rounded (16px), soft shadow for elevation

**Page Structure:**
1. **Header:** Minimal logo, centered
2. **Login Card:** Centered form with email, password fields, "Forgot password?" link
3. **Submit Button:** Primary Sage "Sign In" button
