  ...
  return (
    <div className="relative min-h-screen bg-brand-bg">
      ...
      <div className="relative flex min-h-screen flex-col lg:flex-row">
        <aside className="hidden w-[264px] border-r border-brand-border/90 bg-brand-surface/70 px-4 py-6 backdrop-blur lg:block">
          <div className="mb-8 px-2">
            <Link href="/" className="inline-flex items-center rounded-md">
              <Image
                src="/assets/logo/logo-lockup.svg"
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "flex items-center gap-3 rounded-lg border px-3 py-2.5 text-sm transition-colors duration-180",
                    active
                      ? "border-brand-accent/60 bg-brand-accent/15 text-brand-text1"
                      : "border-transparent text-brand-text2 hover:border-brand-border hover:bg-brand-surface2",
                  )}
                >
          ...
          <header className="sticky top-0 z-20 border-b border-brand-border bg-brand-bg/90 backdrop-blur">
            <div className="mx-auto w-full max-w-[1320px] px-4 py-4 md:px-6 lg:px-8">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="hidden items-center gap-2 rounded-full border border-brand-border bg-brand-surface2 px-3 py-1.5 text-sm text-brand-text2 md:inline-flex">
